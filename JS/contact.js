...
(function () {
    ...
    form.addEventListener("submit", async function (event) {
        ...
        /*
         * The database is intentionally not exposed to the public UI
         * when it is unavailable. Mailto keeps the portfolio usable
         * until Supabase is configured or temporarily recovers.
         */
